...
if __name__ == "__main__":
    ...
    for res in [('3600','L1000N','m8'), ('1800','L1000N','m9'), ('5040','L2800N','m9')]:
        ds_acc = yt.load("saved_data/" + res[1] + "/" + res[0] + '/' + res[2] + "_acc_500c_z"+str(z)+"_1e14_50kpc.h5")
        ds_mag = yt.load("saved_data/" + res[1] + "/" +  res[0] + '/' + res[2] + "_mag_500c_z"+str(z)+"_1e14_50kpc.h5")
        ...
        plt.scatter(x,median, label = res[1] + res[0])
